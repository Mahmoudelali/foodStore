	...
	<Pressable onPress={navigation}>
		<View className="flex flex-row py-6 pl-10">
			...
			<View className="flex flex-row items-center">
				<Text className="basis-[70%] pl-10 pb-1 tracking-[1] font-normal">
					{optionName}
				</Text>
	...
	const staticOptions = [
		{
			...
			icon: (
				<Entypo name="info-with-circle" size={24} color="#13d0ca" />
			),
		},
	...
	
		{
			...
			icon: (
				<FontAwesome name="pencil-square-o" size={24} color="#13d0ca" />
			),
		},
